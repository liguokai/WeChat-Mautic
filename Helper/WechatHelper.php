...
namespace MauticPlugin\MauticWechatBundle\Helper;
...
use MauticPlugin\MauticWechatBundle\Event\WechatSendEvent;
...
class WechatHelper
{
    ...
    public static function send(MauticFactory $factory, $lead, $event)
    {
        ...
        /** @var \MauticPlugin\MauticWechatBundle\Api\AbstractWechatApi $wechat */
        $wechatApi = $factory->getKernel()->getContainer()->get('mautic.wechat.api');

        /** @var \MauticPlugin\MauticWechatBundle\Model\WechatModel $wechatModel */
